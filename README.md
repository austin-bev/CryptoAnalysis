This was my submission for the final assessment of COMP1002 (v.1) Data Structures and Algorithms (2021). The task was to create a program which imported and then parsed graph data using data structures. 
